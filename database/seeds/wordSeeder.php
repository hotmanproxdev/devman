...
class wordSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('prosystem_words')->insert([
            ...
            [   'id'=>5,
                'url_path'=>'profile',
                'word_data'=> '{"file_upload_false_msg_warning":"Profil resminizi de\u011fi\u015ftiremedik l\u00fctfen tekrar deneyiniz.Dosya y\u00fcklenmedi,izinlerinizi kontrol ediniz","file_upload_false_title_warning":"Profil Resim De\u011fi\u015fikli\u011fi Hatas\u0131",
