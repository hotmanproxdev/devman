...
namespace App\Http\Controllers\Mandev\Roles\source;
...
class rolesController extends Controller
{
    ...
    public function __construct (Request $request,rolesModel $model)
    {
        //page protector
        ...
        return $this->tsql
                    ...
                    ->contentIn(
                        [
                            ...
                            'modal'=>
                                [
                                    'edit'=>['action'=>'roles/edit','title'=>'Tsql Editleme Bölümü']
                                ],
