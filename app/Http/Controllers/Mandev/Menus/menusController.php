...
use App\Http\Controllers\Mandev\Menus\source\sourceController as Source;
use DB;
use Validation;
use Notification;
use Input;
...
class menusController extends Controller
{
        ...
        public function __construct (Request $request,menusModel $model,Validation $validation,Notification $notification,Source $source)
        {
             //page protector
             ...
             //page role
             $this->data['pageRole']=$this->app->pageRole(['pageRole'=>0,'admin'=>$this->admin]);
             //admin view
        ...
        */
        ...
        {
            //get menus list
            $this->data['query'] = $this->source->data("menus")->get("get");
        ...
        |
        */
        public function postMenusfilter()
        {
                ...
                return app("\Role")->get(1,function()
                {
                    ...
                    return app("\Token")->valid(function()
                    {
                        ...
                        return $this->validation->make([],function()
                        {
                            ...
                            return app("\Query")->isTrue($this->model->postprocessmenus(),function()
                            {
            ...
            if($key=="menu")
            {
                $rules=array(
                        "str_empty"=>[
                                            ...
                                            $this->data['menuvalidation']=>[Input::get("menu")],
                                            $this->data['iconvalidation']=>[Input::get("icon")],
                                            $this->data['parentvalidation']=>[Input::get("parent")],
                                            $this->data['rowvalidation']=>[Input::get("row")]
