...
namespace App\Http\Controllers\Api\Custom\V1\instagram;
...
class InstagramApi extends Controller implements \App\Http\Controllers\Api\InterfaceApi
{
    ...
    /*
    |--------------------------------------------------------------------------
    | Application Api Custom Get Method Instagram User Endpoints
    |--------------------------------------------------------------------------
    |
    | Here is where you can register instagram user endpoint of the api for an application.
    ...
    */
    ...
    public function get ()
    {
        ...
        */
        return $this->versionControl->get([__CLASS__,__METHOD__],function()
        {
           ...
           */
           $query=$this->env->get("instagramEndpoints")->run(['endpoint'=>"users"]);
    ...
    /*
    |--------------------------------------------------------------------------
    | Application Api Custom Get Method Instagram Media Endpoints
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    public function media ()
    {
        ...
        return $this->versionControl->get([__CLASS__,__METHOD__],function()
        {
             ...
             * @model api model default get run
             */
            $query=$this->env->get("instagramEndpoints")->run(['endpoint'=>"media"]);
