...
class BeforeMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        $this->app->insertLang(["url_path"=>"default","word_data"=>['update_profile_manipulation'=>'Manipulation Yaptınız,Kendi grubunuz harici kişilere müdahale edemezsiniz'],"lang"=>1]);
