...
<head>
  <meta charset="utf-8"/>
  <title>Prosystem | Login Form</title>
  ...
  <link href="{{$baseUrl}}/metron/theme/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
  <a href="">
    <img src="{{$baseUrl}}/metron/theme/assets/admin/layout2/img/logo-big.png" alt=""/>
  </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
  ...
  <form class="login-form" action="" method="post">
    ...
    <div class="form-group">
      ...
      <label class="control-label visible-ie8 visible-ie9">Ccode</label>
      <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="{{$ccode}}" name="ccode"/>
    </div>
    <div class="form-group">
      <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
    ...
    <div class="create-account">
      <p>
        <a href="" id="register-btn" class="uppercase">Developer : Ali Gürbüz [sde]</a>
      </p>
    </div>
  </form>
  <!-- END LOGIN FORM -->
...
<div class="copyright">
  2015 © Prosystem Managing System .
</div>
<!-- END LOGIN -->
...
<script src="{{$baseUrl}}/metron/theme/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="{{$baseUrl}}/metron/theme/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
