<div class="col-md-6 col-sm-6">
  ...
  <div class="portlet light ">
    ...
    <div class="portlet-body">
      ...
      <div id="site_activities_content4" class="display-none">
        <div id="site_activities4" style="height: 228px;">
        </div>
      </div>
...
<div class="col-md-6 col-sm-6">
  ...
  <div class="portlet light ">
    ...
    <div class="portlet-body">
      <div id="site_activities_loading5">
        <img src="{{$baseUrl}}/metron/theme/assets/admin/layout2/img/loading.gif" alt="loading"/>
      </div>
      <div id="site_activities_content5" class="display-none">
        <div id="site_activities5" style="height: 228px;">
        </div>
      </div>
      <div style="margin: 20px 0 10px 30px">
        <div class="row">
