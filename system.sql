...
# Database: Prosystem
# Generation Time: 2016-01-14 14:04:08 +0000
# ************************************************************
...
INSERT INTO `prosystem_administrator` (`id`, `ccode`, `username`, `password`, `email`, `hash`, `fullname`, `last_ip`, `created_at`, `updated_at`, `photo`, `extra_info`, `lang`, `user_lock`, `role`, `system_name`, `system_number`, `phone_number`, `address`, `occupation`, `website`, `last_login_time`, `user_where`, `status`, `logout`, `logout_time`, `created_by`, `is_mobile`, `is_tablet`, `is_desktop`, `is_bot`, `browser_family`, `os_family`, `all_clicked`, `hash_clicked`, `operations`, `success_operations`, `fail_operations`, `noauth_area_operations`)
VALUES
	(1,'devSde','aligurbuz','7ada520f7fb0eb935a11f392511fe86e','galiant781@gmail.com','282320edd528bf3952075fc75e4f868b','Ali Bilge Gürbüz','127.0.0.1',1447331070,1452778909,'48832.jpg','it can be written later',1,1,'1-2-3','Developer\n',0,'0545 906 29 92','İstanbul','Software Developer','http://sw.devx.net',1452778727,'/mandev/home',1,0,0,NULL,0,0,1,0,'Chrome','MacOSX',4,4,0,0,0,0);
