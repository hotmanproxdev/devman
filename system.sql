...
# Database: Prosystem
# Generation Time: 2016-01-14 14:57:33 +0000
# ************************************************************
...
VALUES
	(1,'devSde','aligurbuz','7ada520f7fb0eb935a11f392511fe86e','galiant781@gmail.com','0c44807238c8c108007f1ec77b7f1e0c','0c44807238c8c108007f1ec77b7f1e0c','Ali Bilge Gürbüz','127.0.0.1',1447331070,1452783372,'48832.jpg','it can be written later',1,1,'1-2-3','Developer\n',0,'0545 906 29 92','İstanbul','Software Developer','http://sw.devx.net',1452783372,'/mandev/home',1,0,0,NULL,0,0,1,0,'Chrome','MacOSX',25,1,0,0,0,0);
...
INSERT INTO `prosystem_api_accesses` (`id`, `ccode`, `ip`, `apikey`, `statu`)
VALUES
	(1,'devSde','::1','devProAge',1),
	(2,'tkasabasi','::1','csenx12',1);
