...
# Database: Prosystem
# Generation Time: 2016-02-04 14:24:47 +0000
# ************************************************************
...
VALUES
	(1,'devSde','aligurbuz','7ada520f7fb0eb935a11f392511fe86e','info@booksyst.com','d357d6522acec0253a6cab8e15415111','d357d6522acec0253a6cab8e15415111','Ali Bilge Gürbüz','127.0.0.1',1454078251,1447331070,1454593474,'48832.jpg','it can be written later',1,1,'1@3','Developer\n',0,'0545 906 29 92','Ankara','Software Developer','http://www.booksyst.com',1454593471,109904,2257,107647,2549.11,44,'/api/services/test',1,0,0,NULL,0,0,1,0,'Chrome','MacOSX',3952,2,276,199,77,233,233,'5fb259a9da3d036a248d5cfe69ba95f3',''),
...
INSERT INTO `prosystem_api_accesses` (`id`, `ccode`, `ip`, `apikey`, `statu`, `created_at`, `hash`, `standart_key`, `hash_number`, `hash_limit`, `access_service_key`, `access_services`, `api_coding_insert`, `api_coding_update`, `api_coding_delete`, `api_develop_url_filter`)
VALUES
	(1,'develop','127.0.0.1','ali',1,1454575601,'14df40be0e4ee8d925e5afafcf9f4b5e','7d40c8cdfa699c26138080090c09a678',0,3,1,NULL,1,1,1,1),
	(2,'develop','127.0.0.1','alialparslan',1,NULL,NULL,NULL,0,3,1,NULL,1,1,1,0),
	(3,'develop','127.0.0.1','yasindulger',1,1452865683,NULL,NULL,0,3,1,NULL,1,1,1,0),
	(4,'develop','127.0.0.1','murat',1,NULL,'0',NULL,0,3,1,NULL,1,1,1,0);
