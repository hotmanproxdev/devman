...
# Database: Prosystem
# Generation Time: 2016-02-08 14:58:16 +0000
# ************************************************************
...
VALUES
	(1,'devSde','aligurbuz','7ada520f7fb0eb935a11f392511fe86e','info@booksyst.com','3f672c5e95ba501119bb574abd2a3a3d','3f672c5e95ba501119bb574abd2a3a3d','Ali Bilge Gürbüz','127.0.0.1',1454078251,1447331070,1454943451,'48832.jpg','it can be written later',1,1,'1@3','Developer\n',0,'0545 906 29 92','Ankara','Software Developer','http://www.booksyst.com',1454941061,150916,2390,148526,2472.65,62,'/mandev/api/edit',1,0,0,NULL,0,0,1,0,'Chrome','MacOSX',5284,111,279,200,79,274,274,'01ababa9e17716ad52f932fdc3848ffd',''),
...
INSERT INTO `prosystem_api_accesses` (`id`, `system_ccode`, `ccode`, `ip`, `apikey`, `statu`, `created_at`, `hash`, `standart_key`, `hash_number`, `hash_limit`, `access_service_key`, `access_services`, `api_coding_insert`, `api_coding_update`, `api_coding_delete`, `api_develop_url_filter`)
VALUES
	(1,'devsde','develop','127.0.0.1','ali',1,1454659265,'c35075fe99c0a30133d592aedf23270f','7d40c8cdfa699c26138080090c09a678',2,3,1,NULL,1,1,1,1);
